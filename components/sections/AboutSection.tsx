  ...
  return (
    <section className="relative min-h-screen flex flex-col justify-center px-6 md:px-16 lg:px-24 py-32" style={{zIndex:2}}>
      <div className="max-w-4xl mx-auto items-center">
        ...
        >
          <Rv><span className="text-xs" style={{ fontFamily: "'JetBrains Mono'", letterSpacing: 4, color: C.blue }}>// ABOUT MODUS_X</span></Rv>
          ...
          <div className="grid grid-cols-2 gap-4">
            {[
              {n: <InlineMath math="O(1)" />, l:'Memory Complexity'},
              {n: 'Matrix', l:'Long-Range Recall'},
              {n: 'Vector', l:'Local Pattern Tracking'},
              {n: 'Router', l:'Dynamic Blending'}
            ].map(({n,l},i) => (
              <Rv key={i} d={.3+i*.08}>
